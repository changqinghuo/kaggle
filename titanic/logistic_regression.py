...
X = train_data[0::, 1::]
y = train_data[0::, 0]
clf = linear_model.LogisticRegression(C=3, penalty='l1', tol=1e-6)
clf.fit(X, y)
...
print 'Validating'
X_val = train_data[0:100, 1::]
y_val = train_data[0:100:, 0]
...
open_file_object = csv.writer(open("data/logistic_regression.csv", "wb"))
